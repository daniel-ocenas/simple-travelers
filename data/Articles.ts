export const ArticlesContent = [
{
  ...
  "content": [{
    ...
    },
    {
      "component": "img",
      "src": [{
        "src": "../images/photosFull/srdcovky/SlovenskeSrdcovkyArticle.jpg",
...
},
{
  ...
  "content": [{
    ...
    },
    {
      ...
      "children": [{
        "component": "simpleText",
        "text": "Teplé letné dni sú konečne tu! Predstava presedieť ich zavretý doma medzi štyrmi stenami nie je veľmi lákavá... Slovensko je nádherné a&nbsp;výlet do prírody môže spraviť zázraky. Stačí len otvoriť oči a&nbsp;začať vnímať srdcom jeho krásu. V&nbsp;tomto príspevku sa s&nbsp;tebou chceme podeliť o päť tipov na krásne miesta, ktoré patria na náš zoznam slovenských srdcoviek."
      }]
    },
    {
      "component": "h3",
...
},
{
...
},
  {
    ...
    "content": [{
        "component": "h2",
        "text": "To NAJ z nášho Erasmu vo Fínsku"
      },
      {
        "component": "p",
        "children": [{
  ...
  "content": [{
      "component": "h2",
      "text": "Roadtrip USA (1. časť) Zo San Francisca do Monument Valley"
    },
    {
      "component": "p",
      "children": [{
    ...
    },
    {
      ...
      "children": [{
        ...
        {
          "component": "link",
          "text": "Roadtrip USA (2. časť) Z Monument Valley do San Diega",
          "url": "/roadtrip-usa-2"
        }
      ]
    }
...

{
  ...
  "content": [{
    ...
    },
    {
      ...
      "children": [{
          "component": "simpleText",
          "text": "Pokračovanie článku&nbsp;"
        },
        {
          "component": "link",
          "text": "Roadtrip USA (1. časť) Zo San Francisca do Monumet Valley",
          "url": "/roadtrip-usa-1"
        }
      ]
    },
    ...
    },
    {
      ...
      "children": [{
        "component": "simpleText",
        "text": "Hodný úsek našej cesty sme brázdili po legendárnej <b>Route 66</b>. Začali sme v mestečku Williams kúsok od Grand Canyonu a prešli až na samý koniec v <b>Santa Monice</b>. Miestami sme si pripadali ako vo westernovke, rovná cesta a&nbsp;široko ďaleko len chumáče vysušenej trávy. Ale nie, až také vyprahnuté to nebolo, možno len máme napozeraných príliš veľa amerických filmov. "
      }]
    },
    {
      "component": "img",
...

{
  ...
  "content": [{
    ...
    },
    {
      ...
      "children": [{
        "component": "link",
        "text": "Naša cesta naprieč sLOVEenskom časť 2.",
    ...
    },
    {
      ...
      "src": [{
        ...
        },
        {
          ...
          "description": "Na záver náš verný kamarát, ktorý s nami zvládol prejsť celú cestu a vždy na slovíčko počúval."
        }
      ]
    },
    {
      ...
      "children": [{
        "component": "link",
        "text": "Naša cesta naprieč sLOVEenskom časť 1.",
        "url": "/cestahrdinovsnpzapisky"
      }]
    },
    {
...
},
{
  ...
  "content": [{
    ...
    },
    {
      ...
      "children": [{
        "component": "simpleText",
        "text": "Najdlhšia turistická magistrála na území Slovenska. Začína sa v&nbsp;Duklianskom priesmyku a&nbsp;končí sa na hrade Devín. Trasa dlhá 770 km prepája oblasti, ktoré zohrali významnú úlohu počas Slovenského národného povstania, a&nbsp;teda pri oslobodzovaní krajiny v&nbsp;rokoch 1944 – 1945. Značená je červenou značkou, ktorá je na niektorých úsekoch veľmi dobre viditeľná, na iných zas treba na ňu poriadne striehnuť, aby človek nezišiel z chodníka. Terén je vskutku rôznorodý. Kotliny, planiny, vrchoviny či pohoria, ale aj dedinky a&nbsp;veľkomestá. Človek má naozaj jedinečnú možnosť spoznať obrovský kus Slovenska, jeho históriu, kultúru a&nbsp;najmä samého seba. "
      }]
    },
    {
      "component": "img",
...

{
  ...
  "content": [{
      "component": "h2",
      "text": "Rady a tipy - 5 dôvodov prečo (NE)ísť na ERASMUS "
    },
    {
      "component": "p",
      "children": [{
    ...
    },
    {
      ...
      "children": [{
        ...
        },
        {
          ...
          "url": "/radyatipyersmusvybavovacky"
        }
      ]
    },
    {
...
},
{
  ...
  "content": [{
    ...
    },
    {
      ...
      "children": [{
          "component": "simpleText",
          "text": "Asi najbežnejším a&nbsp;najlacnejším spôsobom je Airbnb, ktoré aj my s&nbsp;obľubou využívame. Ceny sa líšia od mesta a&nbsp;od vzdialenosti od centra. Ak ešte nemáš vytvorený účet na Airbnb, použi tento "
        },
        {
          "component": "link",
          "text": "odkaz",
          "url": "https://sk.airbnb.com/c/liviab1667?currency=EUR",
          "type": "external"
        },
        {
          "component": "simpleText",
          "text": " a&nbsp;získaš zľavu na svoje prvé ubytovanie."
        }
      ]
    },
    {
...

{
  ...
  "content": [{
    ...
    },
    {
      ...
      "children": [{
        ...
        },
        {
          "component": "link",
          "text": "odkaz",
          "url": "https://carrental.deals/blg/best-car-rental-companies-in-usa/#/searchcars",
          "type": "external"
        },
        {
          "component": "simpleText",
          "text": " na stránku, kde si môžeš porovnať výhody a&nbsp;nevýhody ponúkaných služieb v&nbsp;jednotlivých spoločnostiach."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "children": [{
          "component": "simpleText",
          "text": "V&nbsp;Alamo sa nám podarilo uplatniť ISIC zľavu, vďaka ktorej sme nemuseli platiť poplatok za mladého a&nbsp;druhého vodiča, zníženie daňových poplatkov, plná nádrž a&nbsp;odovzdanie auta na inej pobočke. -&gt; Good deal!&nbsp;"
        },
        {
          "component": "link",
          "text": "Alamo s ISIC zľavou",
          "url": "https://partner.rentalcar.com/isic-angebot/?locale=en_GB",
          "type": "external"
        }
      ]
    },
    {
      ...
      "children": [{
          "component": "simpleText",
          "text": "V&nbsp;Enterprise, sme si objednali auto, ktoré spadalo do najnižšej kategórie, ale&nbsp;ústretový pracovník nám ho &nbsp;bez poplatku vymenil za auto o&nbsp;3 kategórie lepšie."
        },
        {
          "component": "link",
          "text": "Požičovna Enterprise",
...

{
  ...
  "content": [{
    ...
    },
    {
      ...
      "children": [{
        "component": "simpleText",
        "text": "Čo všetko je súčasťou našej výbavy, sa môžeš dočítať v&nbsp;nasledujúcom článku ..... LINK....."
      }]
    },
    {
      "component": "p",

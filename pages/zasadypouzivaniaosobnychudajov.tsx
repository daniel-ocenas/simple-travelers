  ...
  return (
    <Page>
      <div className="screen-reader-text">
        ...
        <p>Vaše osobné údaje spracovávame z dôvodu zlepšenia poskytovania obsahu nášho blogu a jeho kvality.</p>
        <p>
          <b>
            Zbieranie osobných údajov môže znieť hrozivo, avšak jedná sa len o údaje prehliadania našich stránok vo
            forme cookies súborov.
          </b>
        </p>
        <p>
        ...
        <p>
          Správca prevádzkuje webové stránky lindatraveler.sk. Správca vaše údaje spravuje a určuje, ako dlho budú
          osobné údaje spracovávané a za akým účelom. Správca taktiež vyberá ďalších spracovateľov, ktorých k
          spracovaniu využíva.
        </p>
        ...
        <p>
          Právu na prístup – môžete náš požiadať o informáciu o tom, aké údaje o vás spracovávame a prečo. Následne do
          30 dní vám túto informáciu doložíme.
        </p>
        <p>
        ...
        <p>
          ...
          takom prípade vymažeme všetky vaše osobné údaje, ktoré o vás uchovávame. Na vykonanie tohto práva potrebujeme
          30 dní.
        </p>
        <h3>Mlčanlivosť</h3>
        <p>
          Sme povinní zachovávať mlčanlivosť o osobných údajoch, ktorých zverejnenie by ohrozilo zabezpečenie vašich
          osobných údajov. Táto mlčanlivosť pritom trvá aj po skončení záväzkových vzťahov s nami. Bez vášho súhlasu
          vaše údaje žiadnej inej tretej strane nevydáme.
        </p>

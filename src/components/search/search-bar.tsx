  ...
  return (
    ...
    >
      ...
      <input
        ...
        value={query}
        className={`w-full rounded-full border-2 border-gray-300 py-4 pl-14 pr-12 text-xl font-medium hover:border-red-500 focus:border-red-500 focus:bg-customGray-base focus:outline-hidden dark:border-gray-400 dark:bg-customGray-dark dark:focus:bg-customGray-light ${
